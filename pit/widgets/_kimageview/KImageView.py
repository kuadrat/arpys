# -*- coding: utf-8 -*-
"""
Variation of the original ImageView.py widget by Luke Campagnola.
Puts histogram on the left side.
...
from kustom.arpys.pit.widgets.kimageview.ImageViewTemplate_pyqt import *
...
class KImageView(QtGui.QWidget):
    """
